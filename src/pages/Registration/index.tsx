...
const Registration: React.FC = () => {
  ...
  const openLoginFormHandler = useCallback(
    () => changePage(AUTHORIZATION_ROUTE),
    []
  );
  const onSubmitForm = useCallback(() => {
    if (userName && city && dateBirth && email && password) {
      changePage(CATEGORIES_INTERESTS_ROUTE);
    }
  }, [userName, city, dateBirth, email, password]);
    ...
    <div className={styles.container}>
      ...
      <div className={styles.rightContent}>
        ...
        <div className={styles.contentForm}>
          <div className={styles.heading}>Регистрация</div>
          ...
          <form>
            ...
            <div className={styles.registrationButtonContainer}>
              <Button
                ...
                type="submit"
                disabled={!(userName && city && dateBirth && email && password)}
